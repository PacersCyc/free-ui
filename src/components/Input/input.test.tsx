...
describe('test Input component', () => {
  ...
  it('should render different input sizes on size property', () => {
    ...
    const testContainer = wrapper.container.querySelector('.free-input-wrapper')
  ...
  it('should render prepand and append element on prepand/append property', () => {
    ...
    const testContainer = container.querySelector('.free-input-wrapper')
    expect(testContainer).toHaveClass('free-input-wrapper input-group input-group-append input-group-prepend')
